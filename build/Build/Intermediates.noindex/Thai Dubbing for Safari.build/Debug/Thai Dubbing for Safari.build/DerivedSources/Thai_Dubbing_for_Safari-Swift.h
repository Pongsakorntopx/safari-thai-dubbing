...
#ifndef THAI_DUBBING_FOR_SAFARI_SWIFT_H
#define THAI_DUBBING_FOR_SAFARI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Thai_Dubbing_for_Safari",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC23Thai_Dubbing_for_Safari11AppDelegate")
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC23Thai_Dubbing_for_Safari14ViewController")
