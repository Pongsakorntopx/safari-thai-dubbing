...
#ifndef THAI_DUBBING_FOR_SAFARI_EXTENSION_SWIFT_H
#define THAI_DUBBING_FOR_SAFARI_EXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Thai_Dubbing_for_Safari_Extension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC33Thai_Dubbing_for_Safari_Extension25SafariWebExtensionHandler")
