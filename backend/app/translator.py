...
หน้าที่ของคุณคือ:
1. อ่านทำความเข้าใจเนื้อหาทั้ง 60 วินาทีนี้ เพื่อให้เห็นภาพรวมของเรื่องราว และวิเคราะห์ระดับภาษาที่เหมาะสมตามเนื้อหาคลิป
2. 'เขียนบทพากย์ภาษาไทยขึ้นมาใหม่' (Full Creative Transcreation) โดยใช้ภาษาพูดที่คนไทยใช้สนทนาจริง ฟังง่าย สละสลวย ชัดเจน และเป็นธรรมชาติ
...
4. ห้ามแปลตรงตัวคำต่อคำแบบภาษาเขียนแข็งๆ ให้เรียบเรียงเป็นประโยคภาษาพูดที่ถูกต้องตามหลักไวยากรณ์ไทย ฟังแล้วเข้าใจง่ายและได้สาระครบถ้วน
...
- **รักษาใจความและข้อมูลสำคัญของต้นฉบับให้ครบถ้วน 100% ห้ามตัดทอนเนื้อหา**
- ใช้คำพูดที่เป็นกันเอง ภาษาพูดทั่วไป ฟังง่าย ชวนติดตาม
