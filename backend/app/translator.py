...
หน้าที่ของคุณคือ:
1. อ่านทำความเข้าใจเนื้อหาทั้ง 60 วินาทีนี้ (ไม่ว่าต้นฉบับจะเป็นภาษาอังกฤษ, ญี่ปุ่น, เกาหลี, จีน, สเปน หรือภาษาใดก็ตาม) เพื่อให้เห็นภาพรวมของเรื่องราว และวิเคราะห์ระดับภาษาที่เหมาะสมตามเนื้อหาคลิป
2. 'เขียนบทพากย์ภาษาไทยขึ้นมาใหม่ทั้งหมด' (Full Creative Transcreation) โดยใช้ภาษาพูดที่คนไทยใช้สนทนาจริง ฟังง่าย สละสลวย ชัดเจน และได้ใจความสมบูรณ์ 100%
3. ห้ามแปลตรงตัวคำต่อคำเด็ดขาด ให้จับใจความสำคัญแล้วเรียบเรียงเป็นประโยคภาษาพูดที่กระชับ ตรงประเด็น และลงตัวกับจังหวะเวลาในคลิป
4. ใช้ระดับภาษาและน้ำเสียงที่เหมาะสมกับเนื้อหาคลิป (สอนใช้งาน, เล่าเรื่อง, บันเทิง, หนัง)
