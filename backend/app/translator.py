...
1. **พากย์ด้วยเสียงคนเดียวตลอดทั้งคลิป 100% (Single Consistent Host Voice):**
   ...
   - สรรพนามและคำลงท้าย:
     - ผู้ชาย: ใช้ 'ผม / เรา', ลงท้าย 'ครับ / นะครับ' เสมอ 100%
     - ผู้หญิง: ใช้ 'ฉัน / เรา / หนู', ลงท้าย 'ค่ะ / นะคะ' เสมอ 100%
2. **แก้ไขการตัดคำและสร้างประโยคที่สมบูรณ์ในตัวเอง (Zero Word Splitting & Complete Sentences):**
   - **กฎเหล็ก:** แต่ละท่อน [1], [2], [3]... ต้องเป็น "ประโยคที่พูดจบสมบูรณ์ ฟังเข้าใจได้ทันทีในท่อนนั้น"
   - **ห้ามตัดประโยคค้างคา ห้ามตัดคำผสมแยกจากกัน** (เช่น ห้ามตัด 'ระบบ' อยู่อีกท่อน แล้ว 'ปฏิบัติการ' อยู่อีกท่อน, ห้ามทิ้งท้ายท่อนด้วย 'ที่...', 'และ...', 'เพื่อ...' แล้วไปต่อท่อนหน้า)
   - หากต้นฉบับภาษาอังกฤษถูกตัดท่อนมาแบบขาดตอน ให้เรียบเรียงภาษาไทยของแต่ละท่อนให้มีความสมบูรณ์ในตัวเอง โดยเกลี่ยใจความให้ทั้งสองท่อนเป็นประโยคที่สละสลวย
3. **ปรับแต่งจังหวะการพูดและความยาวของประโยคให้พอดีกับเวลา (Exact Duration Pacing - 3.5 พยางค์/วินาที):**
   - การพูดภาษาไทยที่เป็นธรรมชาติใช้ความเร็วประมาณ 3.5 ถึง 4 พยางค์ต่อ 1 วินาที
   - ดูเวลาในวงเล็บ (duration เช่น 1.5s, 3.0s, 5.0s) แล้วแต่งประโยคให้มีความยาวพยางค์พอดี:
     - ท่อน 1.0–1.5s: ใช้ประโยคสั้นมาก 4–6 พยางค์ (เช่น "เริ่มกันเลยครับ", "ดูตรงนี้เลยครับ")
     - ท่อน 2.0–3.0s: ใช้ประโยคขนาดกลาง 7–11 พยางค์ (เช่น "วิธีนี้ติดตั้งได้ง่ายมากเลยครับ")
     - ท่อน 4.0–6.0s: ใช้ประโยคยาว 14–20 พยางค์ (เช่น "และที่สำคัญนะครับ เราสามารถปรับแต่งค่าต่างๆ ได้ตามใจชอบเลยครับ")
   - **ห้ามแต่งประโยคยาวเกินเวลาเด็ดขาด** เพื่อให้คนพากย์พูดได้ทันตามจังหวะปกติโดยไม่ต้องเร่งเสียง
4. **ส่งผลลัพธ์เป็น JSON Array เท่านั้น ในรูปแบบ:**
[
  {{"id": 1, "speaker": "host", "gender": "{gender}", "emotion": "cheerful", "rate": "+0%", "thai": "ข้อความภาษาไทยที่พากย์อย่างเป็นธรรมชาติและจบประโยคสมบูรณ์"}},
