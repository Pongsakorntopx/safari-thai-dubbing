...
👉 **โมเดลที่รองรับ (แยกเสียงชาย - หญิง):**
1. `🧁 KhanomTan TTS v1.1 (หญิง)`: โมเดลเสียงผู้หญิง ขนมตาล v1.1 นุ่มนวล ชัดเจน เป็นธรรมชาติ (Linda)
2. `🧁 KhanomTan TTS v1.1 (ชาย)`: โมเดลเสียงผู้ชาย ขนมตาล v1.1 อบอุ่น ทุ้มนุ่ม ชัดถ้อยชัดคำ (Thorsten)
3. `🇹🇭 VITS Thai Master (หญิง)`: โมเดล VITS เสียงไทยแท้ เสียงผู้หญิง วรรณยุกต์ 5 เสียงและสระสั้น-ยาวแม่นยำ
4. `🇹🇭 VITS Thai Master (ชาย)`: โมเดล VITS เสียงไทยแท้ เสียงผู้ชาย ทุ้มลึก สุภาพ ชัดเจน
